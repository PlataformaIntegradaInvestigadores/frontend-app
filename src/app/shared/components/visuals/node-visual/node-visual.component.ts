  ...
  template: `
    ...
    <ng-template #popContent>
      ...
      <div class="mt-2 pt-1 border-top" *ngIf="node.popover.link || node.popover.expandable">
        <a *ngIf="node.popover.link" [routerLink]="['/profile', node.id]"
           class="btn btn-sm btn-outline-primary text-center d-block w-100 mb-1">View profile</a>
        <button *ngIf="node.popover.expandable" type="button" (click)="onExpand(p1)"
                [disabled]="node.isExpanded" class="btn btn-sm w-100"
